            ...
            <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $counter++ }}</td>
                            <td><b>{{ $item->ma_don_hang }}</b></td>
                            <td><b>{{ $item->ma_khach_hang }}</b></td>
                            <td><b>{{ $item->dai_ly_ten }}</b></td>
                            ...
                            <td>
                                <a href="{{route('view',$item->id)}}"><i class="fa fa-eye" style='font-size:24px;margin-right:5px'></i></a>
                                <a href="{{route('edit_payment',$item->id)}}"><i class='far fa-edit' style='font-size:24px;margin-right:5px'></i></a>
                                @if(Auth::user()->role == 1)
                                <a href="" onclick="return confirm('Bạn có chắc muốn xóa không?')"><i class='far fa-trash-alt' style='font-size:24px'></i></a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
