      ...
      <div class="row tm-content-row">
        <div class="col-12 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto" style="      display: grid;
            ...
            <div>
              <a href="{{route('themmoi')}}" class="button">Thêm mới</a>
            </div>
          </div>
          <form action="{{ route('nguoi_quan_ly') }}" method=" get">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto" style="      display: grid;
      ...
      <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              <!-- <td>
                <input type="checkbox" name="ids[{{$us->id}}]" value="{{$us->id}}">
              </td> -->
              <td><b>{{$us->id}}</b></td>
              <td><b>{{$us->Ma_don_vi}}</b></td>
              <td><b>{{$us->name}}</b></td>
              <td><b>{{$us->sodienthoai}}</b></td>
              <td><b>{{$us->email}}</b></td>
              <td>
                <a href="{{route('edit_user',$us->id)}}"><i class='far fa-edit' style='font-size:24px;margin-right:5px'></i></a>
                <a href="{{route('xoa',$us->id)}}" onclick="return confirm('Bạn có chắc muốn xóa bài viết này không?')"><i class='far fa-trash-alt' style='font-size:24px'></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
