      ...
      <div class="row tm-content-row">
        <div class="col-12 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto" style="      display: grid;
            ...
            <div>
              <a href="{{route('add_thong_tin_chung')}}" class="button">Thêm mới</a>
            </div>
          </div>
          <form action="{{ route('thong_tin_chung') }}" method=" get">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto" style="      display: grid;
        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th scope="col">Nhóm thông tin</th>
              <th scope="col">Ngày tạo</th>
              <th scope="col">Thao tác</th>
            </tr>
          </thead>
          <tbody>
            @foreach($thong_tin_chung as $item)
            <tr>
              <!-- <td>
              ...
              <td>
                <a href="{{route('edit_thong_tin_chung',$item->id)}}"><i class='far fa-edit' style='font-size:24px;margin-right:5px'></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
