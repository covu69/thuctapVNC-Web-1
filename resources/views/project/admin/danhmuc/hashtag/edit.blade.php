                ...
                <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                    ...
                    <div class="row tm-edit-product-row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <form action="{{route('update_hashtag',$htag->id)}}" enctype="multipart/form-data" method="post" class="tm-edit-product-form">
                                @csrf
                                @method('PUT')
                                <div class="form-group mb-3">
                                    <label for="name">Tên Tag
                                    </label>
                                    <input id="name" name="name" type="text" value="{{$htag->name}}" class="form-control validate" />
                                    @error('name')
