  ...
  <div class="" id="home">
    ...
    <div class="container mt-5">
      <div class="row tm-content-row">
        <div class="col-12 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto" style="      display: grid;
            ...
            <div>
              <a href="{{route('add_nhasanxuat')}}" class="button">Thêm mới</a>
            </div>
          </div>
          <form action="{{ route('nhasanxuat') }}" method=" get">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto" style="      display: grid;
      ...
      <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
        <h2 class="tm-block-title">Nhà sản xuất</h2>
        <table class="table">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><b>{{$item->name}}</b></td>
              <td>
                <a href="{{route('edit_nhasx',$item->id)}}"><i class='far fa-edit' style='font-size:24px;margin-right:5px'></i></a>
                <a href="{{route('xoa_nhasx',$item->id)}}" onclick="return confirm('Bạn có chắc muốn xóa bài viết này không?')"><i class='far fa-trash-alt' style='font-size:24px'></i></a>
              </td>
            </tr>
            @endforeach
          </tbody>
