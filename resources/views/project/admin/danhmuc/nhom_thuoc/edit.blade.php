                ...
                <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                    ...
                    <div class="row tm-edit-product-row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <form action="{{route('update_nhomthuoc',$nt->id)}}" enctype="multipart/form-data" method="post" class="tm-edit-product-form">
                                @csrf
                                @method('PUT')
                                <div class="form-group mb-3">
                                    <label for="name">Tên nhóm thuốc
                                    </label>
                                    <input id="name" name="name" type="text" value="{{$nt->name}}" class="form-control validate" />
                                    @error('name')
