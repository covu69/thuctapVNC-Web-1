        ...
        <div class="row">
            <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
                <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                    ...
                    <div>
                        <div>
                            <form action="{{route('save_news')}}" method="post" class="tm-edit-product-form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    <label for="category">Ảnh thumnail</label>
                                ...
                                <div class="form-group mb-3" style="margin-top:0px">
                                    ...
                                    <textarea class="form-control" id="ckeditor" name="mo_ta" value="{{ old('mo_ta') }}" rows="5"></textarea>
                                </div>

                                <div class="form-group mb-3">
                                    <label for="expire_date">Ngày công khai
                                    </label>
                                    <input id="unit" value="{{ old('ngay_cong_khai') }}" name="ngay_cong_khai" type="date" class="form-control validate" required />
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3" style="margin-top:0px">
                                    ...
                                    <textarea class="form-control" id="ckeditor_1" name="noi_dung" value="{{ old('noi_dung') }}" rows="5"></textarea>
                                </div>
